...
IndexIterator::IndexIterator(CacheManager *cm, PageID page_id, int entry_idx):
    cache_manager_(cm),
...
void IndexIterator::assign_to_null_page() {
    cur_page_ = nullptr;
    cur_raw_page_ = nullptr;
    cur_page_id_ = INVALID_PAGE_ID;
    entry_idx_ = -1;
